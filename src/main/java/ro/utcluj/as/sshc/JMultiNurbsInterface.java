...
public class JMultiNurbsInterface {
	...
	private void loadNurbs() {
		try {
			java.io.ObjectInputStream objInStream = new java.io.ObjectInputStream(
					new java.io.FileInputStream("nurbs.tmp"));
	...
	public void saveNurbs(java.io.File file) {
		try {
			java.io.ObjectOutputStream objOutStream = new java.io.ObjectOutputStream(
